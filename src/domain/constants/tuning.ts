...
export const FISH_TURN_SMOOTHING = 0.08;

// ---------------------------------------------------------------------------
// Wall avoidance
// ---------------------------------------------------------------------------

export const FISH_WALL_AVOIDANCE_DISTANCE = 60;
export const FISH_WALL_AVOIDANCE_STRENGTH = 0.12;
/** Extra repulsion very close to walls (within half the avoidance distance) */
export const FISH_WALL_HARD_REPULSION = 0.4;
...
export const FISH_HOVER_CHANCE = 0.004;
/** Base ticks for a hover */
export const FISH_HOVER_DURATION = 60;
/** Velocity damping each tick while hovering */
export const FISH_HOVER_DAMPING = 0.92;
...
export const FISH_INVESTIGATE_DURATION = 50;
...
export const FISH_NIGHT_SPEED_MULTIPLIER = 0.35;
